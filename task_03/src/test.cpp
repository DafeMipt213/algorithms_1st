...
TEST(SortTest, SimpleChar) {
  ...
  ASSERT_EQ(QuickSort<char>({'a', 'b', 'c'}), (std::vector<char>{'a', 'b', 'c'}));
  ASSERT_EQ(QuickSort<char>({'c', 'b', 'a'}), (std::vector<char>{'a', 'b', 'c'}));
}
...
TEST(SortTest, EvenChar) {
  ...
  ASSERT_EQ(QuickSort<char>({'a', 'a', 'b', 'c'}), (std::vector<char>{'a', 'a', 'b', 'c'}));
  ASSERT_EQ(QuickSort<char>({'a', 'b', 'a', 'c'}), (std::vector<char>{'a', 'a', 'b', 'c'}));
  ASSERT_EQ(QuickSort<char>({'a', 'a', 'b', 'c', 'b'}), (std::vector<char>{'a', 'a', 'b', 'b', 'c'}));
  ASSERT_EQ(QuickSort<char>({'a', 'b', 'a', 'c', 'b'}), (std::vector<char>{'a', 'a', 'b', 'b', 'c'}));
}
