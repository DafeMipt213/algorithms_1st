...
void
TreeNode::setLeft (TreeNode *newLeft)
{
  left = newLeft;
}

void
TreeNode::setRight (TreeNode *newRight)
{
  right = newRight;
}

void
TreeNode::setKey (int newKey)
{
  key = newKey;
}

void
TreeNode::setValue (int newValue)
{
  value = newValue;
}
...
void
Tree::InsertOrUpdate (int key, int value)
{
...
TreeNode *
Tree::Insert (TreeNode *node, int key, int value)
{
  if (node == nullptr)
    {
...
TreeNode *
Tree::FindNode (TreeNode *node, int key) const
{
